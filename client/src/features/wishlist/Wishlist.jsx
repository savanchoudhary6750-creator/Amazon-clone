...
import { useWishlist } from '../../app/providers/WishlistContext.jsx';
        ...
        {items && items.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {items.map(item => {
              ...
              return (
                <div key={product._id || item._id} className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow">
